...
const heroIcons = [
  ...
  { iconName: "earth-europe", text: "Global Expansion" },
];
    ...
    <div className="container">
      <section className="services-section">
        ...
        <header className="content">
          <h3>Our Services</h3>
          <h1>
            Your Trusted Partner for Complete Freight and Warehousing Assistance
          </h1>
          <p>
            Embark on a journey of optimized supply chains with our diverse
            services. From cutting-edge storage facilities to advanced
            temperature-controlled transport, we ensure secure deliveries across
            the UK and Europe. Explore our European Operation for reliable
            international trade facilitation. Tailored for just-in-time supply
    ...
    <>
      <div className="container">
        <section className="about-us-section">
          <h1>
            FreshLinc: Your Supply Chain Partner, Moving Goods with Confidence
          </h1>
          ...
          <article className="content">
            ...
            <div className="information">
              <div className="text-container">
                ...
                <p>
                  Experience streamlined supply chain management with our
              ...
              <div className="text-container">
                ...
                <p>
                  Reach markets across UK and Europe with our expansive network
                  of warehouses and transport fleet.
                </p>
              </div>
              <div className="text-container">
                <h1>Dedicated to Customer Success</h1>
                <p>
                  Your goals are our priority. We are committed to ensuring your
                  business thrives with efficient logistics.
                </p>
              </div>
            </div>
          </article>
    ...
    <section className="container">
      <section className="join-us-section">
        <div className="content">
          ...
          <h1>Join Our Team</h1>
          <p>
            At FreshLinc, our team is the driving force behind our success,
            providing market-leading logistical solutions with unwavering
            commitment to service. We prioritize the growth and development of
            our colleagues, offering diverse opportunities for skill enhancement
    ...
    <section className="group-section">
      ...
      <article className="groups-divisions">
        <section className="offices-section">
          ...
          <p>
            The FreshLinc Group delivers a spectrum of logistics solutions and
            expertise tailored to industry demands. Explore our divisions for
